...
var targetResultUrl = ["/predict-result-tpl0.html", "/predict-result-tpl1.html", "/predict-result-tpl2.html", "/predict-result-tpl3.html", "/predict-result-tpl4.html"],
    ...
    volunteerSchoolProfessConf = {
        ...
        "gd": {
            ...
            "professN": 6,
            "professSwap": 0,
            "targetUrlCode": ["3", "3", "3", "1", "1"],
            "resultUrl": targetResultUrl[3],
            // "SchoolUrl": [targetSelectSchoolUrl[3], targetSelectSchoolUrl[3], targetSelectSchoolUrl[3], targetSelectSchoolUrl[1], targetSelectSchoolUrl[1]],
            "batch": ["1", "2-1", "2-2", "3-1", "3-2"],
            "threshold": {
                gd_1: [90, 5150],
                gd_2: [300, 14100]
            },
        ...
        "tj": {
            ...
            "batch": ["1-1", "1-2", "2-1", "2-2", "4-1", "4-2", "4-3", "3"]
        },
        "ln": {
            "name": '辽宁',
            "schoolN": 6,
    ...
    switch (province) {
        ...
        case 'gd':
            if (batch == '3-1' || batch == '3-2') {
                volunteerSchoolProfessConf[province].resultUrl = targetResultUrl[1];
            }
            break;
        case 'jx':
            if (batch == '3-1' || batch == '3-2') {
