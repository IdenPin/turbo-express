...
define(['commonjs', '../css/data/data-school-info.css', 'handlebars', 'timeFormat', 'cookie', 'noDataTips', 'autoComplete'], function (util, dataSchoolInfoCss, handlebars, getTime, cookie, noDataTips) {
    ...
    //    $('#search-list-main').on('click', '.set-target', function () {
    //        window.location.assign('/user-target.html')
    //        var thisSchool = $(this).attr('schoolName');
    //        util.cookie.setCookie("targetScore", "", 4, "");
    //        util.cookie.setCookie("targetSchool", thisSchool, 4, "");
    //    });
    //} else {
    //    $('#search-list-main .set-target').attr('disabled', disabled);
    //}
    //// 录取预测
    //$('#search-list-main').on('click', ',.forecasting', function () {
    //    window.location.assign('/predict-degree.html');
    //    var thisSchool = $(this).attr('schoolName');
    //    util.cookie.setCookie("targetScore", "", 4, "");
    //    util.cookie.setCookie("targetSchool", thisSchool, 4, "");
    //});
    ...
    //静态图片
    var sideBanner1 = require('../img/side-banner1.jpg');
    $('#side-banner1').attr('src', sideBanner1);
    var sideBanner2 = require('../img/side-banner2.jpg');
    $('#side-banner2').attr('src', sideBanner2);
    var sideBanner3 = require('../img/side-banner3.jpg');
    $('#side-banner3').attr('src', sideBanner3);
    var sideBanner4 = require('../img/side-banner4.jpg');
