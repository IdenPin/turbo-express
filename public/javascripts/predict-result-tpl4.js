 ...
 * “智高考”报名人数、排名为空时显示
 * */
define(['commonjs', 'tips', 'handlebars', 'cookie', 'timeFormat', 'printArea', '../css/volunteer/predict-result-tpl3'], function (util, tips, handlebars, cookie, getTime, printArea) {
    //路由判断
     ...
     * 第几批次第几志愿
     * */
    handlebars.registerHelper('batchNumber', function (v1, v2, options) {
        if (v1 < v2) {
            switch (v1) {
                case 1:
                    v1 = 'A';
...
//==================河南==========================
     ...
     * 第几批次第几志愿
     * */
    handlebars.registerHelper('batchNumber1', function (v1) {
        var str = '';
        switch (v1) {
            case 1:
                v1 = 'A';
